...
Usage:
    python scripts/fit_calibration_for_plm.py \\
        --plm esm-2-t36-L36 \\
        --output data/hard_candidates/bundles/calibration_esm-2-t36-L36.csv \\
        --plm-rf-dir outputs/PlmRandomForest/esm-2-t36-L36/all_folds/all_classes/<ts> \\
        --plm-dom-rf-dir outputs/PlmDomainsRandomForest/esm-2-t36-L36/all_folds/all_classes/<ts>
"""
...
def main() -> None:
    ...
    artefacts = fit_calibration_table(oof_per_clf)
