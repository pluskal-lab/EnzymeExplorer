...
from enzymeexplorer.src.models.config_classes import (
    EmbWithDomainsRandomForestConfig,
    EmbMLPConfig,
    EmbLogisticRegressionConfig,
)
from enzymeexplorer.src.models.plm_randomforest import PlmRandomForest
from enzymeexplorer.src.models.ifaces import BaseConfig
from enzymeexplorer.src.models.ifaces.domains_sklearn_model import (
